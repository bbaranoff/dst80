...
def search_key(C, mysig):
    ...
    while (S != mysig):
        ...
        print("Challenge=",hex(C),"Signature=",hex(S),"key=",keyl,keyr)
        i=i+1

print("Challenge ?")
C=input()
C=int(C,16)
mysig=dst80(0x955a3eaaaa,0xaaaac1a56a,0xc212345678)
print("debug : Signature=",hex(mysig),"keyl=0x955a3eaaaa keyr=0xaaaac1a56a")
print("Signature ?")
mysig=input()
mysig=int(mysig,16)
search_key(C,mysig)
